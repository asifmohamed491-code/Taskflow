...
export const SIDEBAR_CLASSES = {
  ...
  mobileDrawer:
"fixed top-0 left-0 h-screen w-72 max-w-[80vw] bg-white backdrop-blur-md border-r border-purple-100 shadow-2xl z-50 p-5 flex flex-col space-y-6 overflow-y-auto transition-transform duration-300",
}
